...
template<uint32_t limbs>
__device__ __forceinline__ void mp_shift_right(uint32_t* r, const uint32_t* x, uint32_t bits, uint32_t fill=0) {
  #pragma unroll
...
template<uint32_t limbs>
__device__ __forceinline__ void mp_shift_left(uint32_t* r, const uint32_t* x, uint32_t bits, uint32_t fill=0) {
  #pragma unroll
