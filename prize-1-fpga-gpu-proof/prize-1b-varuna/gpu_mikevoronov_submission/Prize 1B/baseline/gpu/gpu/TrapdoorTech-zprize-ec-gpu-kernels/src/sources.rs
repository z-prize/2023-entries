...
static MULTIEXP_BUCKET_SRC: &str = include_str!("./kernels/matter/multiexp_bucket.cu");
...
static FF_DISPATCH_ST_SRC: &str = include_str!("./kernels/matter/ff_dispatch_st.cuh");
