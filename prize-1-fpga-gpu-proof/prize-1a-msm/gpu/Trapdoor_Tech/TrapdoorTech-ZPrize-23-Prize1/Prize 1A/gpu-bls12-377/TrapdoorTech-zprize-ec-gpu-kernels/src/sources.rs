...
// static FF_CONFIG_SRC: &str = include_str!("./kernels/matter/ff_config.cu");
...
fn multiexp_bucket(point: &str, field: &str) -> String {
    String::from(MULTIEXP_BUCKET_SRC).replace("POINT", point).replace("FIELD", field)
}
