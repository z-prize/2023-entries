...
impl CudaDevice {
    ...
    pub fn get_multiprocessor_count(&self) -> CudaResult<usize> {
        let mut sms = 0i32;
        ...
        let cores: usize = sms.try_into().unwrap();
    ...
    pub fn get_memory(&self) -> CudaResult<u64> {
        ...
        let result = unsafe {
            cuDeviceTotalMem_v2(&mut total_mem as *mut size_t, self.inner)
        };
