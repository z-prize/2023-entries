...
extern "C" {
    #[link_name = "\u{1}_Z11addmixed_opPK7data384S1_S1_S1_S1_PS_S2_S2_"]
    pub fn addmixed_op(
        arg_in: *const argument_element_t,
        res_out: *const result_element_t,
    );
}
