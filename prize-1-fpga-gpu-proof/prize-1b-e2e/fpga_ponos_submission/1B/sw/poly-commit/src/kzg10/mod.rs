    ...
    for<'a, 'b> &'a P: Div<&'b P, Output = P>,
{
    ...
    pub fn commit(
        ...
        let mut commitment = ponos_engine::run_msm_opt(
            &powers.powers_of_g[num_leading_zeros..],
            &powers.n_powers_of_g[num_leading_zeros..],
            &plain_coeffs,
        );
        end_timer!(msm_time);
        ...
        // let random_ints_copy = random_ints.clone();
        let msm_time =
            start_timer!(|| "MSM to compute commitment to random poly");
        let random_commitment = ponos_engine::run_msm_opt(
            &powers.powers_of_gamma_g,
            &powers.n_powers_of_gamma_g,
    ...
    pub(crate) fn open_with_witness_polynomial<'a>(
        ...
        let mut w = ponos_engine::run_msm(
            &powers.powers_of_g[num_leading_zeros..],
            &witness_coeffs,
        );
