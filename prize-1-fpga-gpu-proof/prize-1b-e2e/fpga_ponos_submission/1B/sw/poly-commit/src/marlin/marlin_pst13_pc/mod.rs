    ...
    P::Point: Index<usize, Output = E::Fr>,
{
        ...
        P: 'a,
    {
        ...
        for p in polynomials {
            ...
            let mut commitment = ponos_engine::run_msm(&powers_of_g, &plain_ints);
            end_timer!(msm_time);
            ...
            let random_commitment =
                ponos_engine::run_msm(&powers_of_gamma_g, &random_ints).into_affine();
            end_timer!(msm_time);
        ...
        Self::Commitment: 'a,
    {
        ...
        let mut w = witnesses
            ...
            .map(|w| {
                ...
                // Compute MSM
                ponos_engine::run_msm(&powers_of_g, &witness_ints)
            })
            .collect::<Vec<_>>();
